...
<body>
    ...
    <div>
        <hr>
        <marquee><h2>Personal Data</h2></marquee>
        <hr>
    </div>
    ...
    <?php
    	...
    	echo "<tr><td>".$count."</td><td>".$row['firstname']." ".$row['middlename']." ".$row['lastname']."</td><td>".$row['date']."</td><td>".$row['bloodgroup']."</td><td>".$row['profession']."</td><td>".$row['email']."</td><td>".$row['address']."</td><td>".$row['contact']."</td></tr>";
    	$count++;
    }
    ?>
</table>
