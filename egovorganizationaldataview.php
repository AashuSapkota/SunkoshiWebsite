...
<head>
    ...
    <title>Organizational Data</title>
...
<body>
    ...
    <hr>
        <marquee><h2>Organizational Data</h2></marquee>
        <hr>
    </div>
    ...
    <?php
    	...
    	echo "<tr><td>".$count."</td><td>".$row['orgname']."</td><td>".$row['type']."</td><td>".$row['subtype']."</td><td>".$row['email']."</td><td>".$row['address']."</td><td>".$row['contact']."</td></tr>";
    	$count++;
    }
    ?>
</table><br>
