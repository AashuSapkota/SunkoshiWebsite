...
<head>
    ...
    <title>Update Organizational Data</title>
...
<body>
    ...
    <div> <hr><h1>Update Organizational Data</h1><hr></div>
    ...
    <?php
    	...
    	$count=1;
    	$query="select * from organizationaldata";
    	$result=mysqli_query($conn,$query);
    	while($row=mysqli_fetch_array($result)){
            $id=$row['id'];
    	echo "<tr><td>".$count."</td><td>".$row['orgname']."</td><td>".$row['type']."</td><td>".$row['subtype']."</td><td>".$row['email']."</td><td>".$row['address']."</td><td>".$row['contact']."</td><td><a href='includes/edito.php?id=$id'>Edit</a></td><td><a href='includes/deleteo.php?id=$id'>Delete</a></td></tr>";
    	$count++;
    }
    ?>
</table>
