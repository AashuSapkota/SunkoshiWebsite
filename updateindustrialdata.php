...
<body>
    ...
    <?php
        ...
        $id=$row['id'];
    	echo "<tr><td>".$count."</td><td>".$row['name']."</td><td>".$row['type']."</td><td>".$row['email']."</td><td>".$row['address']."</td><td>".$row['contact']."</td><td><a href='includes/editi.php?id=$id'>Edit</a></td><td><a href='includes/deletei.php?id=$id'>Delete</a></td>"."</td></tr>";
    	$count++;
    }
    ?>
</table>
