...
$id=$_GET['id'];
$query="select * from industrialdata where id='$id'";
...
<body>
	...
	<div>
		<h2>Update Info</h2>
		<form class="reg-container" action="updatei.php" method="POST">
			<input type="hidden" name="id" value="<?php echo $id ?>">
			Industryname:<input type="text" name="name" value="<?php echo $name ?>"><br>
			Type:<select name="type" value="<?php echo $type ?>">
					<option>Mini</option>
					<option>Micro</option>
					<option>Local</option>
				</select>
			<br>ContactInformation:<input type="text" name="email" value="<?php echo $email ?>">
